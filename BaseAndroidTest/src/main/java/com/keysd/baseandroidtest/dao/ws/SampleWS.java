 ...
 * Description:
 * This class will only be used for create a dummy request object and parse a dummy response in
 * order to test the
 * cryptographic operations and parsers for the base request and response models
 */

package com.keysd.baseandroidtest.dao.ws;

import com.google.gson.Gson;
import com.google.gson.JsonSyntaxException;
import com.keysd.baseandroid.dao.ws.ResponseErrorException;
import com.keysd.baseandroid.dao.ws.WSClient;
import com.keysd.baseandroid.model.ws.MessageErrorCode;
import java.util.LinkedList;
import java.util.List;

/**
 * Class that implements a base invoke example to be as generic client class for most common web
 * services clients that
