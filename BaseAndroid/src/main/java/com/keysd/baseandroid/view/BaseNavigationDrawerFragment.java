 ...
 * design guidelines</a> for more details about it. This base fragment will implement common
 * functions like showing and
...
public class BaseNavigationDrawerFragment extends Fragment {
   ...
   * @param drawerPosition Position of the drawer,
   * {@link android.support.v4.view.GravityCompat#START},
   *                       {@link android.support.v4.view.GravityCompat#END}
   * @param toolbar        Toolbar where to be attached the navigation toggle.
   * @param appName        Resource id of the string to be shown when the drawer its open
   */
  public void setUp(int fragmentId, DrawerLayout drawerLayout, int drawerPosition, Toolbar toolbar,
      int appName) {
   ...
   * @param appName        Resource id of the string to be shown when the drawer its open
   */
  public void setUp(int fragmentId, DrawerLayout drawerLayout, Toolbar toolbar, int drawerPosition,
      int appName) {
  ...
  protected void closeDrawer() {
    if (!lockDrawer) {
      mDrawerLayout.closeDrawer(drawerPosition);
    }
  }
