...
package com.keysd.baseandroid.controller;

import android.database.Cursor;
import android.util.Log;
import com.keysd.baseandroid.dao.db.BaseDBDAO;
...
public abstract class BaseDBController<T extends BaseModel> {
  ...
  /**
   * Projection map that will be used by default on the query statement, by default the
   * projection map will be null
   *
   * @return The projection map maps from column names that the caller passes into query to
	 * database column names.
   * This is useful for renaming columns as well as disambiguating column names when doing joins.
	 * For example you
   * could map "name" to "people.name". If a projection map is set it must contain all column
	 * names the user may
  ...
  /**
   * Sets the progress updater to be used on the data base helper, this is used when the data
	 * base is initialized
   *
