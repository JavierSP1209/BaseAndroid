...
package com.keysd.baseandroidtest.util;
 ...
 * @since 20/05/13
 */
public class KeyDictionary extends com.keysd.baseandroid.util.KeyDictionary {

  /**
   * Tag to be used for log entries across the application
   */
  public static final String TAG = "BASE_TAG_TEST";
