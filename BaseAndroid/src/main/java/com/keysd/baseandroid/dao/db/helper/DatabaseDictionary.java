 ...
 * Description:
 * Class which contains static values for all the Data base base_dictionary needed across the
 * application,
 * this values could
...
public class DatabaseDictionary {
  ...
  /**
   * Base com.keysd.baseandroid.dao.db structure which contains filter id value
   */
