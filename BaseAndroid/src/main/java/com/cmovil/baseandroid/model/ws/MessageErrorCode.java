 ...
 * Description: 
 *  Base structure of errors for the communication between PDA and SIVA with AmaneceNET, the errors should have an error
 * code and error description
 */
package com.cmovil.baseandroid.model.ws;

/**
 * Base structure of errors for the communication between an application and the server, the errors should have an
