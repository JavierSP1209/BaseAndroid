...
package com.keysd.baseandroid.model.db;
...
public abstract class BaseModel implements Serializable {
  ...
  /**
   * Return a string array with the table primary key values, by default this method returns a
   * string array with the
   * {@link #dbId} field, if the primary key is an other field or is a composite this method
   * should be redefined by
   * the corresponding model, the order on which the fields are added must be the same as defined on
   * {@link com.keysd.baseandroid.dao.db.BaseDBDAO#getPrimaryKeyFilter()}
   *
