...
import com.keysd.baseandroid.view.util.BaseListLoader;
import com.keysd.baseandroidtest.R;
import com.keysd.baseandroidtest.model.db.AppEntry;
...
public class AppListFragment extends ListFragment {
  ...
  private final BaseListLoader.BaseLoaderListener<AppEntry> mBaseLoaderListener =
      new BaseListLoader.BaseLoaderListener<AppEntry>() {
        @Override
        public List<? extends BaseListLoader.BaseLoaderObserver> createLoaderObservers(
            BaseListLoader baseListLoader) {
        ...
        public List<AppEntry> onLoadInBackground() {
          ...
          List<ApplicationInfo> apps = getActivity().getPackageManager()
  ...
  private class AppListAdapter extends ArrayAdapter<AppEntry> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      holder.txtApp
          .setCompoundDrawablesWithIntrinsicBounds(getItem(position).getIcon(), null, null, null);
