 ...
 * Description:
 * Data Access Object implementation for State table, will contain all the function that access
 * to the data base
 * table in order to modify or retrieve information
 */

package com.keysd.baseandroidtest.dao.db;
...
import com.keysd.baseandroidtest.dao.db.helper.CustomDataBaseOpenHelper;
...
public class SampleDAO extends BaseDBDAO<State> {
   ...
   * 	if something goes wrong during SQL statements execution
   */
  public Cursor testJoin(String join, String[] columns, Map<String, String> projectionMap) throws
      DBException {
