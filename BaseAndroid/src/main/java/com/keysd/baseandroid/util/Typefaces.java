 ...
 * {@link android.graphics.Typeface#createFromAsset(android.content.res.AssetManager, String)} in
 * which each time the
...
public class Typefaces {
  ...
  /**
   * Gets the requested font type face by name, the font should be on assets directory, the type
   * face is stored on a
